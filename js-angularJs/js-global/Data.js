upload.controller('Load_Data_Controller', function($rootScope, $scope, $http, $location, $cookies, $routeParams) {
        ...
        $rootScope.getDataPagination = function(page_data, page_function, option_value) {
                ...
                if (page_data == 'posts') {
                    ...
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/posts.json';

                    // dữ liệu offline
                    // var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/order.json';
                }
                if (page_data == 'order' || option_value == 'all') {
                    ...
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/donhang.json';
                    if (option_value == 'processed') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/donhang-processed.json';

                    }
                    if (option_value == 'no_processed') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/donhang-no-processed.json';

                    }
                    if (option_value == 'transport') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/donhang-transport.json';

                    }
                    if (option_value == 'complete') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/donhang-complete.json';

                    }
                }
                if (page_data == 'preview_order') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/chitiet-donhang.json';
                }
                if (page_data == 'product') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/product.json';
                }
                if (page_data == 'category') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/category.json';
                }
                if (page_data == 'comment') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/comment.json';
                }
                if (page_data == 'client') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/client.json';
                }
                if (page_data == 'assess') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/assess.json';
                }
                if (page_data == 'baner') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/baner.json';
                }
        ...
        $rootScope.getDataBoxTrash = function(page_data, page_function) {
                ...
                if (page_data == 'posts') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/data-trash.json';
                }
                if (page_data == 'product') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/data-trash-product.json';
                }
                if (page_data == 'category') {
                    // var URL_API_Load = 'https://hqmultimedia.github.io/Angular2026/admin/CrudDataController/get_data_box_trash';
        ...
        $rootScope.LocationBaner = function() {
                ...
                var URL_API_Load = 'https://hqmultimedia.github.io/project-admin-panel/Data/location_baner.json';
